...
public class Yelp {
	...
	public String search(String term, double latitude, double longitude) {
		...
		//    request.addQuerystringParameter("location", "san jose");
		request.addQuerystringParameter("limit", MyApplication.getLimit() + "");
		//    request.addQuerystringParameter("category_filter", "dimsum");
